...
permalink: /publication/2025-08-20-DynamicalAlignment
excerpt: '
Reveals a universal adaptive computation principle in spiking neural networks, showing that input–network timescale matching induces two computational modes—dissipative (efficient) and expansive (high-performance)—enabling fixed architectures to switch capabilities by shaping input dynamics.'
date: 2025-08-20
...
<img width="2034" height="948" alt="image" src="https://github.com/user-attachments/assets/834f59d2-72c2-43e2-9b3f-72b3a7986872" />
